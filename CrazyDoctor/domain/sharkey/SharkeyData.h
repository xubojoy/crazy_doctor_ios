...
@protocol SharkeyData
@end
@interface SharkeyData : JSONModel
...
@property (nonatomic ,assign) int sleepTimeTotal;// 睡眠总时长
@property (nonatomic ,assign) int sleepTimeDeep;// 深度睡眠时长
@property (nonatomic ,assign) int sleepTimeLight;// 浅度睡眠市场
