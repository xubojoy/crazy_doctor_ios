...
- (void)setTitle:(NSString *)title forState:(MJRefreshState)state
{
    ...
    self.stateLabel.textColor = [ColorUtils colorWithHexString:light_gray_text_color];
}
...
- (void)setLastUpdatedTimeKey:(NSString *)lastUpdatedTimeKey
{
    ...
    if (lastUpdatedTime) {
        ...
        self.lastUpdatedTimeLabel.textColor = [ColorUtils colorWithHexString:light_gray_text_color];
    } else {
