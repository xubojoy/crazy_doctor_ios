...
#define YXDTitleLableWidthHeightRate        0.6
...
- (void) action_createSectionTitles {
    ...
    for (int i = 0; i < _sectionTitleArray.count; i++) {
        ...
        UILabel *lable = [self action_createTitleLableWithTitle:_sectionTitleArray[i]
                                                          frame:CGRectMake(0,
                                                                           self.frame.size.width*YXDTitleLableWidthHeightRate*i,
...
- (UILabel *) action_createTitleLableWithTitle:(NSString *)title frame:(CGRect)frame {
    ...
    lable.textColor = [ColorUtils colorWithHexString:common_app_text_color];
    lable.text = title;
    lable.backgroundColor = [UIColor clearColor];
    lable.font = [UIFont boldSystemFontOfSize:smaller_font_size];
    return lable;
}
...
+(YXDCustomIndexView *)customIndexViewWithWidth:(float)width
    ...
    float height = width*YXDTitleLableWidthHeightRate * sectionTitleArray.count;
...
//    customIndexView.clipsToBounds = YES;
    ...
    customIndexView.backgroundColor = [ColorUtils colorWithHexString:@"#fafafa"];
