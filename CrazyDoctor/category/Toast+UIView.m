...
- (void)makeToastActivity:(id)position {
    ...
    activityView.backgroundColor = [[ColorUtils colorWithHexString:gray_text_color] colorWithAlphaComponent:CSToastOpacity];
    activityView.alpha = 0.0;
    activityView.autoresizingMask = (UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin | UIViewAutoresizingFlexibleTopMargin | UIViewAutoresizingFlexibleBottomMargin);
    activityView.layer.cornerRadius = CSToastCornerRadius;
    
    if (CSToastDisplayShadow) {
        activityView.layer.shadowColor = [ColorUtils colorWithHexString:gray_text_color].CGColor;
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (CSToastDisplayShadow) {
        wrapperView.layer.shadowColor = [ColorUtils colorWithHexString:gray_text_color].CGColor;
        wrapperView.layer.shadowOpacity = CSToastShadowOpacity;
        wrapperView.layer.shadowRadius = CSToastShadowRadius;
        wrapperView.layer.shadowOffset = CSToastShadowOffset;
    }

    wrapperView.backgroundColor = [[ColorUtils colorWithHexString:gray_text_color] colorWithAlphaComponent:CSToastOpacity];
...
//        CGSize expectedSizeTitle = [title sizeWithFont:titleLabel.font constrainedToSize:maxSizeTitle lineBreakMode:titleLabel.lineBreakMode];
        ...
        CGSize expectedSizeTitle = [title
                              boundingRectWithSize:maxSizeTitle
...
//        CGSize expectedSizeMessage = [message sizeWithFont:messageLabel.font constrainedToSize:maxSizeMessage lineBreakMode:messageLabel.lineBreakMode];
        ...
        CGSize expectedSizeMessage = [message
                                    boundingRectWithSize:maxSizeMessage
                                    options:NSStringDrawingTruncatesLastVisibleLine
                                    attributes:attributes
                                    context:nil].size;
